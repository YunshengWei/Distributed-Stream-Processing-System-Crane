...
public class ClientLogQuerier {
	...
	//reading host name and port number and storing in an arraylist of class Catalog
	...
	public void connect(String hostName,String portName) throws UnknownHostException, IOException
	{
